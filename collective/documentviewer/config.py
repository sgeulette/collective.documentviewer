...
CONVERTABLE_TYPES = {
    ...
    "word": DocType(u"Word Document", ("doc", "docx", "dot", "wiz", "odt", "sxw", "wks", "wpd", "vor", "sdw")),
    "excel": DocType(
        u"Excel File",
        (
            "xls",
    ...
    "ppt": DocType(u"Powerpoint", ("ppt", "pptx", "pps", "ppa", "pwz", "odp", "sxi")),
...
GROUP_VIEW_DISPLAY_TYPES = ("Folder", "Large Plone Folder", "Plone Site", "Topic")
