...
class DocumentViewer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        xmlconfig.file("configure.zcml", collective.documentviewer, context=configurationContext)
...
DocumentViewer_FUNCTIONAL_TESTING = FunctionalTesting(bases=(DocumentViewer_FIXTURE,), name="DocumentViewer:Functional")
...
def createObject(context, _type, id, delete_first=True, check_for_first=False, **kwargs):
